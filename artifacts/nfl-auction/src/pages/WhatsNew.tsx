    ...
    <div className="mx-auto max-w-4xl space-y-8 p-4 md:p-8">
      <header>
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 shrink-0 items-center justify-center border border-primary/30 bg-primary/5 text-primary">
            <Sparkles className="h-5 w-5" aria-hidden="true" />
          </div>
          <div>
            <h1 className="text-3xl font-extrabold uppercase tracking-tighter md:text-5xl">
              What&apos;s New
            </h1>
      ...
      <section aria-labelledby="faq-title" className="space-y-4">
        ...
        <details open className="group border border-border bg-background">
